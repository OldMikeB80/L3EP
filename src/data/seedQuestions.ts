...
export const sampleQuestions: Partial<Question>[] = [
  ...
  // Additional NDT Methods Questions
  {
    ...
    options: [
      ...
      { id: 'b', text: 'The region immediately beneath the probe where defects cannot be detected' },
      { id: 'c', text: 'The area outside the sound beam' },
      { id: 'd', text: 'The region of maximum attenuation' },
    ],
    correctAnswer: 'b',
    explanation: 'The dead zone is the region immediately beneath the probe face where defects cannot be detected due to the transmission pulse and near-field effects.',
    difficulty: 'medium',
  ...
  {
    categoryId: 'ndt_methods',
    question: 'Which eddy current testing frequency would provide the best penetration in aluminum?',
    options: [
      { id: 'a', text: '100 Hz' },
      { id: 'b', text: '1 kHz' },
      { id: 'c', text: '100 kHz' },
    ...
    correctAnswer: 'b',
    explanation: 'Lower frequencies provide better penetration in conductive materials. 1 kHz offers good penetration in aluminum while maintaining reasonable sensitivity.',
    difficulty: 'hard',
  ...
  {
    categoryId: 'ndt_methods',
    question: 'What is the primary advantage of phased array ultrasonic testing over conventional UT?',
    options: [
    ...
    correctAnswer: 'b',
    explanation: 'Phased array UT allows electronic beam steering and focusing without moving the probe, enabling rapid inspection of complex geometries.',
    difficulty: 'medium',
  ...
  // Additional Materials & Processes Questions
  {
    ...
    correctAnswer: 'b',
    explanation: 'Hydrogen cracking (cold cracking) typically occurs in the HAZ due to hydrogen embrittlement, residual stress, and susceptible microstructure.',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'The IIW carbon equivalent formula considers the effect of various alloying elements on hardenability and weldability.',
    difficulty: 'hard',
  ...
  {
    categoryId: 'materials_processes',
    question: 'Which heat treatment process is used to relieve residual stresses without significantly affecting hardness?',
    options: [
    ...
    correctAnswer: 'c',
    explanation: 'Stress relieving involves heating below the transformation temperature to relieve residual stresses without significantly changing mechanical properties.',
    difficulty: 'easy',
  ...
  {
    categoryId: 'cert_standards',
    question: 'According to ASNT SNT-TC-1A, what is the minimum near vision acuity requirement for NDT personnel?',
    options: [
    ...
    correctAnswer: 'b',
    explanation: 'SNT-TC-1A requires near vision acuity of Jaeger J2 at not less than 12 inches for NDT personnel.',
    difficulty: 'easy',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'CP-189 is an ANSI/ASNT standard with mandatory requirements, while SNT-TC-1A is a recommended practice providing guidelines.',
    difficulty: 'medium',
  ...
  // Additional Safety & Quality Questions
  {
    ...
    correctAnswer: 'b',
    explanation: 'ALARA (As Low As Reasonably Achievable) is the principle of minimizing radiation exposure by considering economic and social factors.',
    difficulty: 'easy',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'CAPA (Corrective And Preventive Action) is a systematic approach to eliminate causes of non-conformities and prevent recurrence.',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'Root cause analysis aims to identify the fundamental cause of a problem to implement effective corrective actions and prevent recurrence.',
    difficulty: 'easy',
  ...
  // Advanced NDT Methods Questions
  {
    ...
    correctAnswer: 'b',
    explanation: 'The Kaiser effect is the absence of detectable acoustic emissions until the previous maximum applied stress level is exceeded.',
    difficulty: 'hard',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'Wet fluorescent particles with DC magnetization provide the highest sensitivity due to particle mobility and fluorescent contrast.',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'Lift-off effect is the change in coil impedance caused by variations in the distance between the probe and test surface.',
    difficulty: 'medium',
    references: ['ASNT ET Level III Study Guide'],
  ...
  {
    categoryId: 'materials_processes',
    question: 'What is the primary mechanism of stress corrosion cracking in austenitic stainless steels?',
    options: [
    ...
    correctAnswer: 'b',
    explanation: 'Austenitic stainless steels are susceptible to chloride-induced stress corrosion cracking, typically occurring as transgranular cracking.',
    difficulty: 'hard',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'Trailing shields provide inert gas coverage to protect the hot weld and HAZ from atmospheric contamination during cooling.',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'Sensitization in 304 SS occurs when exposed to 800-1500°F, causing chromium carbide precipitation at grain boundaries.',
    difficulty: 'hard',
  ...
  {
    categoryId: 'cert_standards',
    question: 'Under NAS-410, what is the maximum period of significant interruption before requalification is required?',
    options: [
      { id: 'a', text: '6 months' },
      { id: 'b', text: '12 months' },
      { id: 'c', text: '18 months' },
    ...
    correctAnswer: 'b',
    explanation: 'NAS-410 requires requalification if an individual has not performed NDT in the method for 12 continuous months.',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 'a',
    explanation: 'ASME Boiler and Pressure Vessel Code Section V provides NDT methods and requirements for nuclear applications.',
    difficulty: 'easy',
  ...
  // Practical Application Questions
  {
    ...
    correctAnswer: 'c',
    explanation: 'Confined spaces present dual hazards: radiation exposure with limited escape routes and potential oxygen deficiency.',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 'b',
    explanation: 'TOFD probe separation is typically 1.5 to 2 times the wall thickness for optimal coverage of the weld volume.',
    difficulty: 'hard',
...
export async function seedDatabase() {
  ...
  try {
    ...
    for (const questionData of sampleQuestions) {
      ...
      console.log(`After inserting question ${questionCount}, category ${question.categoryId} has ${verify.length} questions`);
    }
    ...
    console.log(`📊 Final counts - Categories: ${finalCategories.length}, Questions: ${finalQuestions.length}`);
